...
@section('sign')
    <form style="height:440px;margin-top:-60px" action="/register-hero" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-select" id="country" name="origin_country">
        ...
        <div class="form-group">
            <label class="form-label" for="country">Country you play with</label>
            <select class="form-select" id="country" name="play_country">
                <option value="">__</option>
                @foreach ($countries as $country)
                <option value="{{ $country->id }}">{{ $country->country }}</option>
                @endforeach
        ...
        <div class="form-group">
            <label class="form-label" for="country">Country you play with</label>
            <select class="form-select" id="country" name="sport">
                <option value="">__</option>
                @foreach ($countries as $country)
                <option value="{{ $country->id }}">{{ $country->country }}</option>
                @endforeach
