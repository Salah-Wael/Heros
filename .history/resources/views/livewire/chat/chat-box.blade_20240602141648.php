<div 
    ...
    x-init="
        ...
        .notification((notification)=>{
            if(notification['type']== 'App\\Notifications\\MessageRead' && notification['conversation_id']== {{ $selectedConversation ? $selectedConversation->id : 'null' }})
            {
                markAsRead=true;
            }
        });
        ...
        <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b">
            <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
                ...
                <h6 class="font-bold truncate">
                    {{ $selectedConversation ? $selectedConversation->getReceiver()->email : 'No conversation selected' }}
                </h6>
            </div>
        </header>
        {{-- body --}}
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="ml-auto flex gap-2">
                                ...
                                {{-- message status, only show if message belongs to auth user --}}
