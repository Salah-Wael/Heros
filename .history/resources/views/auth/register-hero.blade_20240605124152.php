    ...
    <form style="height:440px;margin-top:-60px" action="/register-hero" method="POST">
        ...
        <div>
            <label for="image" class="custom-file-upload">
                <span>Send 4 Images for your self</span>
                <input type="file" name="images[]" id="image1" accept=".jpeg, .jpg, .png, .jfif, .svg" >
                <input type="file" name="images[]" id="image2" accept=".jpeg, .jpg, .png, .jfif, .svg" >
                <input type="file" name="images[]" id="image3" accept=".jpeg, .jpg, .png, .jfif, .svg" >
                <input type="file" name="images[]" id="image4" accept=".jpeg, .jpg, .png, .jfif, .svg" >
            </label>
        </div>
        @if($errors->has('image'))
        <div class="alert alert-danger">
