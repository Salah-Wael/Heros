...
Route::controller(AdminController::class)->group(function(){
    Route::get('/heros_request', 'herosRequest')->name('heros.show_request');
    Route::delete('/heros_request/{id}/delete', 'delete')->name('heros.delete');
    Route::get('/heros_request/create', 'insertIntoHerosTable')->name('heros.create');
    Route::put('/heros_request/{id}', 'update')->name('news.update');
