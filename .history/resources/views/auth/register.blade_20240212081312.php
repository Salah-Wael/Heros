                    ...
                    <div style="width:100%;display: flex;height:200px;align-items:center;">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                <label class="form-label" for="exampleInputnam1">First name</label>
                                <input type="text" class="form-control mb-0" name='firstName' value="{{ old('firstName') }}" required id="exampleInputEmail1" placeholder="First name">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-0" name='lastName' value="{{ old('lastName') }}" required id="exampleInputEmail1" placeholder="Last name">
                            </div>
