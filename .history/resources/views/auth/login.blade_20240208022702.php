...
@section('sign')
    ...
    <div class="text-center" style="height:40px;background-image: linear-gradient(to right,#DF63FF,#82E9EF);display: flex;align-items: center;justify-content: center;">
    {{ session('success')  }}
    </div>
