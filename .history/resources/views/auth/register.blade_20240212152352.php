            ...
            <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5" style="height: 820px;overflow-y: auto;">
                    ...
                    <div style="width:100%;display: flex;height:200px;align-items:center;">
                        ...
                        @csrf
                            ...
                            <div>
                            <label>day</label><input type="number" value="1" name="day" min="1" max="31" step="1">
                            <label>month</label><input type="number" value="1" name="month" min="1" max="12" step="1">
                            <label>year</label><input type="number" value="1910" name="year" min="1910" max="2022" step="1">
                            </div>
