...
class ChatBox extends Component
{
    ...
    // {
    //     return view('livewire.chat.chat-box', compact('selectedConversation', 'query'));
    // }
    public $selectedConversation;
    public $body;
    public $loadedMessages;
    ...
    public function broadcastedNotifications($event)
    {
        if ($event['type'] == MessageSent::class && $event['conversation_id'] == $this->selectedConversation->id) {
            $this->dispatchBrowserEvent('scroll-bottom');
            $newMessage = Message::find($event['message_id']);
            $this->loadedMessages->push($newMessage);
    ...
    public function render()
    {
        return view('livewire.chat.chat-box', ['selectedConversation' => $selectedConversation])->with(['selectedConversation' => $selectedConversation] );
    }
}
