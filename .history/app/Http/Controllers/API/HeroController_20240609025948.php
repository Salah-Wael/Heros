...
class HeroController extends Controller
{
    ...
    public function updateHeroProfile(Request $request, $id){
        ...
        if ((auth()->user()->role == 'hero' && auth()->user()->id == $hero->auth_id)) {
            ...
            $updateData = [
                'firstName' => $validatedData['title'],
                'lastName'=> $validatedData['title'],
                'shortName'=> $validatedData['title'],
                'height'=> $validatedData['title'],
                'weight'=> $validatedData['title'],
                'origin_country'=> $validatedData['title'],
                'play_country'=> $validatedData['title'],
                'sport'=> $validatedData['title'],
                'password'=> $validatedData['title'],
                'birthDate'=> $validatedData['title'],
                'gender'=> $validatedData['title'],
