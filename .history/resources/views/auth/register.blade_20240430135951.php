...
<body class=" ">
    ...
    <script src="{{ a }}/assets/js/libs.min.js"></script>
    <!-- slider JavaScript -->
    <script src="{{ a }}/assets/js/slider.js"></script>
    <!-- masonry JavaScript -->
    <script src="{{ a }}/assets/js/masonry.pkgd.min.js"></script>
    <!-- SweetAlert JavaScript -->
    <script src="{{ a }}/assets/js/enchanter.js"></script>
    <!-- SweetAlert JavaScript -->
    <script src="{{ a }}/assets/js/sweetalert.js"></script>
    <!-- app JavaScript -->
    <script src="{{ a }}/assets/js/charts/weather-chart.js"></script>
    <script src="{{ a }}/assets/js/app.js"></script>
    <script src="{{ a }}/vendor/vanillajs-datepicker/dist/js/datepicker.min.js"></script>
    <script src="{{ a }}/assets/js/lottie.js"></script>
    <script >
