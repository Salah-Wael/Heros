                     ...
                     <div id="post-modal-data" class="card card-block card-stretch card-height">
                        ...
                        <div class="card-body">
                           ...
                           <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                              ...
                              <li class="me-3 mb-md-0 mb-2">
                                 <a href="#" class="btn btn-soft-primary">
                                    <img src="../assets/images/small/015.png" alt="icon" class="img-fluid me-2"> Video
                                    <div class="vpostcustom_file">
                                       <input type="file">
                                    </div>
                                 </a>
                              <li class="me-3 mb-md-0 mb-2">
                                 <a href="#" class="btn btn-soft-primary">
                                    <img src="../assets/images/small/016.png" alt="icon" class="img-fluid me-2"> Music
                                    <div class="mpostcustom_file">
                                       <input type="file">
                                    </div>
                                 </a>
                              <li class="me-3 mb-md-0 mb-2">
                                 <a href="#" class="btn btn-soft-primary">
                                    <img src="../assets/images/small/12.png" alt="icon" class="img-fluid me-2">Articles
                                    <div class="apostcustom_file">
                                       <input type="file">
                                    </div>
                                 </a>
                           </ul>
                                    ...
                                    <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3">
                                             ...
                                             <div class="post1custom_file">
                                                <input type="file">
                                             </div>
                                          </div>
                                       </li>
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img src="../assets/images/small/015.png" alt="icon" class="img-fluid"> Video
                                             <div class="post2custom_file">
                                                <input type="file">
                                             </div>
                                          </div>
                                       </li>
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img src="../assets/images/small/016.png" alt="icon" class="img-fluid"> Music
                                             <div class="post3custom_file">
                                                <input type="file">
                                             </div>
                                          </div>
                                       </li>
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img src="../assets/images/small/12.png" alt="icon" class="img-fluid"> Articles
                                             <div class="post4custom_file">
                                                <input type="file">
                                             </div>
                                          </div>
                                       </li>
