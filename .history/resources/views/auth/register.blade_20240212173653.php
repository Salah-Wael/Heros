                    ...
                    <div style="width:100%;display: flex;height:200px;align-items:center;">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control mb-0" name='password_confirmation' required id="exampleInputPassword2" placeholder="Confirm Password">
                        </div>

                        <div>
                            <label class="form-label" for="birthDate">Bith Date</label>
                            <input type="date" class="form-control mb-0" value="{{ old('birthDate') }}" required id="birthDate" name="birthDate" >
                        </div>
                        ...
                        <div>
                            ...
                            <input type="radio" id="male" name="gender" value="{{ old('') }}">
