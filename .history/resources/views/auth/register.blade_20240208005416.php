        ...
        <div class="container p-0">
            ...
            <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5" style="height: 820px;overflow-y: auto;">
                    ...
                    <div style="width:100%;display: flex;height:200px;align-items:center;">
                        ...
                        <form style="height:440px;margin-top:-60px" action="/auth.register" method="POST">
                        @csrf

                            <div class="form-group">
                                <label class="form-label" for="exampleInputEmail1">Username</label>
                                <input type="text" class="form-control mb-0" name='name' value="{{ old('name') }}" id="exampleInputEmail1" placeholder="username">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control mb-0" name='email' value="{{ old('email') }}" id="exampleInputEmail2" placeholder="Enter email">
                            </div>
                            <div class="alert alert-danger">
                                @error('email')
                                {{ $message }}
