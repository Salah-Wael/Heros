...
@section('content')
    @if (session('cancelDeposit'))
        ...
        {{ session('cancelDeposit')  }}
        </div>
    @elseif (session('successDeposit'))
        <div style="height:40px;color:black;background-image: linear-gradient(to right,#DF63FF,#82E9EF);display: flex;align-items: center;justify-content: center;">
            ...
            <table border="0" cellpadding="10" cellspacing="0" align="center">
                ...
                <tr>
                    <td align="center">
                        ...
                        title="How PayPal Works" onclick="javascript:window.open('https://www.paypal.com/in/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;">
