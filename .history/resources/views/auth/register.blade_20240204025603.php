            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
                    <div class="sign-in-from">
                        ...
                        <p>Enter your email address and password to access an a.</p>
                        ...
                        @csrf
                            ...
                            <label class="form-label" for="exampleInputPassword1">Confirm Password</label>
                                <input type="password" class="form-control mb-0" name='confirm' id="exampleInputPassword1" placeholder="Confirm Password">
                            </div>
