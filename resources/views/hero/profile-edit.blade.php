                                    ...
                                    <form>
                                        ...
                                        <div class=" row align-items-center">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="text" class="form-control" id="fname" placeholder= <?php echo $first_name?>>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="lname" class="form-label">Last Name:</label>
                                                <input type="text" class="form-control" id="lname" placeholder= <?php echo $last_name?>>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="uname" class="form-label">User Name:</label>
                                                <input type="text" class="form-control" id="uname" placeholder <?php echo $user_name ?>>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="cname" class="form-label">City:</label>
                                                <input type="text" class="form-control" id="cname" placeholder= <?php echo $city?>>
                                            </div>
                                            <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input  class="form-control" id="dob" placeholder= <?php echo $data_of_birth?>>
                                            </div>
                                       <!--     <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input  class="form-control" id="dob" placeholder= <?php echo $age?>>
                                            </div>
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cno" placeholder=<?php echo $contact_number?>>
                                        </div>
                                        <div class="form-group">
                                            <label for="email"  class="form-label">Email:</label>
                                            <input type="text" class="form-control" id="email" placeholder=<?php echo $email?>>
                                        </div>
                                        <div class="form-group">
                                            <label for="url"  class="form-label">Url:</label>
                                            <input type="text" class="form-control" id="url" placeholder=<?php echo $url?>>
                                        </div>
                                        <button type="submit" class="btn btn-primary me-2">Submit</button>
                                        <button type="reset" class="btn bg-soft-danger">Cancle</button>
                                    </form>
