...
Route::controller(AdminController::class)->group(function(){
    ...
    Route::delete('/heros_request/{id}/delete', 'deleteHeroRequest')->name('heros.delete_request');
    Route::delete('/heros_request/{id}/delete', 'forceDeleteHeroRequest')->name('heros.force_delete_request');
