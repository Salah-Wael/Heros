...
class AdminController extends Controller
{
    ...
    public function herosRequest() {
        $herosRequest = HerosRequest::select('firstName as first_name',
            'lastName as first_name', 'fullName as first_name',
            'shortName as first_name', 'height', 'weight', 'sport', 'origin_country', 'play_country',
            'birthDate as first_name', 'gender')->get();
