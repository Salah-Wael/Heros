    ...
    <form style="height:440px;margin-top:-60px" action="/register-hero" method="POST">
        ...
        <div>
            <label for="image" class="custom-file-upload">
                ...
                <input type="file" name="image2" id="image" accept=".jpeg, .jpg, .png, .jfif, .svg" >
                <input type="file" name="image3" id="image" accept=".jpeg, .jpg, .png, .jfif, .svg" >
                <input type="file" name="image4" id="image" accept=".jpeg, .jpg, .png, .jfif, .svg" >
            </label>
        </div>
        @if($errors->has('image'))
        <div class="alert alert-danger">
