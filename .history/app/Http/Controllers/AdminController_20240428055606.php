...
class AdminController extends Controller
{
    ...
    public function archivedHerosRequest() {
        $herosRequest = HerosRequest::onlyTrashed()->get();
        return view('admin.arheros_request', compact('herosRequest'));
    }
    ...
    public function archiveHeroRequest($id){
        HerosRequest::findOrFail($id);
    }
