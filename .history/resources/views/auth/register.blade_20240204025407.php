                    ...
                    <div class="sign-in-from">
                        ...
                        @csrf
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-0" name='password' id="exampleInputEmail1" placeholder="username">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="exampleInputEmail2">Email address</label>
                                <input type="email" class="form-control mb-0" name='password' id="exampleInputEmail2" placeholder="Enter email">
                            </div>
                            <div class="form-group">
