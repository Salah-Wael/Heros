...
@section('sign')
    ...
    <div style="width:100%;display: flex;height:200px;align-items:center;">
        ...
        <a class="sign-in-logo mb-5" style="padding:0px 0px 40px 0;" href="/register">
            ...
            <div class="form-group">
                <label class="form-label" for="exampleInputName2">Short name</label>
                <input type="text" class="form-control mb-0" name='shortName' value="{{ old('shortName') }}" required id="exampleInputName2" placeholder="Short name">
            </div>
