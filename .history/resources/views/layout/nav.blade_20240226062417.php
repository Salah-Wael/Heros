...
@auth
    <nav>
        <ul class="nav-ul">
            ...
            <li class="third even"><a class="third even" href="{{ route('support') }}">Support</a></li>
            <li class="third odd"><a href="news">News</a></li>
            <li class="third even"><a href="#">Information</a></li>
            <li class="third odd"><a href="#">Culture</a></li>
            <li class="third even"><a href="#">Content</a></li>
            <li class="third odd"><a href="{{ route('about') }}">About</a></li>
            <li class="third">
