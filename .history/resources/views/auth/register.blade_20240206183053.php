            ...
            <div class="row no-gutters">
                <div class="col-md-6 text-center pt-5">
                    <div class="sign-in-detail text-white">
                        <a class="sign-in-logo mb-5" href="#"><img src="../assets/images/logo-full.png" style="width:100px;hieght:200px" class="img-fluid" alt="logo"></a>
                        <div class="sign-slider overflow-hidden ">
                            ...
                            <h4 class="mb-1 text-white">Support the Heros</h4>
                                ...
                                <li class="swiper-slide">
                                    <img src="../assets/images/login/3.png" style="border-radius: 20px" class="img-fluid mb-4" alt="logo">
