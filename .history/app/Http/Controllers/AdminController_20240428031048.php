...
class AdminController extends Controller
{
    ...
    public function herosRequest() {
        $herosRequest = HerosRequest::select('firstName as first name',
         'lastName', 'fullName', 'shortName', 'height', 'weight', 'sport', 'origin_country', 'play_country', 'birthDate', 'gender')->get();
