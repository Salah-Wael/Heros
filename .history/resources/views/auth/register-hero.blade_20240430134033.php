        ...
        <a class="sign-in-logo mb-5" style="padding:0px 0px 40px 0;" href="/register">
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <input type="number" class="form-control" name="height" value="{{ old('height') }}" min="10.0" max="2.50" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <input type="number" class="form-control" name="weight" value="{{ old('weight') }}" min="0.0" max="2.50" step="0.01" required>
