            ...
            <div class="row no-gutters">
                        ...
                        <div class="sign-slider overflow-hidden ">
                            <ul  class="swiper-wrapper list-inline m-0 p-0 ">
                                <li class="swiper-slide">
                                    <img src="../assets/images/login/1.png" style="border-radius: 20px;height:100px" class="img-fluid mb-4" alt="logo">
                            <h4 class="mb-1 text-white">Support the Heros</h4>
                                ...
                                <li class="swiper-slide">
                                    <img src="../assets/images/login/2.png" style="border-radius: 20px" class="img-fluid mb-4" alt="logo">
                                    <h4 class="mb-1 text-white">Contact with the Heros</h4>
                                    <p>It is a long established fact that a reader will be distracted by the readable content.</p>
                                </li>
                                <li class="swiper-slide">
                                    <img src="../assets/images/login/3.png" style="border-radius: 20px;height:100px" class="img-fluid mb-4" alt="logo">
                ...
                <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
                    <div class="sign-in-from">
                        <a class="sign-in-logo mb-5" href="#"><img src="../assets/images/loader.png" style="width:100%;hieght:500px" class="img-fluid" alt="logo"></a>
                        ...
                        @csrf
                            ...
                            <label class="form-label" for="exampleInputPassword1">Confirm Password</label>
                                <input type="password" class="form-control mb-0" name='password_confirmation' id="exampleInputPassword1" placeholder="Confirm Password">
                            </div>
