    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $news = DB::table('news')
                ...
                ->leftJoin('tags', 'news_tags.tag_id', '=', 'tags.id') // Left join with tags table
                ->select('news.*', 'users.firstName', 'users.lastName', 'users.role', 'tags.tag_id') // Select the tag_id column from news_tags table
                ->orderBy('news.created_at', 'desc')
                ->get();
