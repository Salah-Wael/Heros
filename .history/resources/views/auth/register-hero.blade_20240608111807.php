...
@section('sign')
    <form style="height:440px;margin-top:-60px" action="/register-hero" enctype="multipart/form-data" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-0" name='name[]' value="Stripe" required id="exampleInputName1" placeholder="Last name">
        </div>
        <div class="form-group">
            <label class="form-label" for="exampleInputName2">Last name</label>
            <input type="text" class="form-control mb-0" name='name[]' value="Fawaterk" required id="exampleInputName2" placeholder="Last name">
        </div>
        <div class="form-group">
            <label class="form-label" for="exampleInputName3">Last name</label>
            <input type="text" class="form-control mb-0" name='name[]' value="Paypal" required id="exampleInputName3" placeholder="Last name">
        </div>
