...
@section('content')
    ...
    <div class="tours">
    <div >
        <img class="nap1" src={{ asset("/assets/images/home/nap1.jpg") }} alt="ski tours">
        <p>ski tours</p>
    </div>
    <div>
    ...
    <div>
        <img src={{ asset("/assets/images/home/nap3.jpg") }} alt="ski tours">
        <p>ski tours</p>
    </div>
    <div>
        <img src={{ asset("/assets/images/home/nap4.jpg") }} alt="ski tours">
        <p>ski tours</p>
    </div>
    <div>
