...
Route::prefix('google')->name('socialite.')->controller(SocialiteController::class)->group(function () {
    ...
    Route::get('/googleRedirect', 'googleRedirect')->name('twitter.redirect');
});
Route::prefix('twitter')->name('socialite.')->controller(SocialiteController::class)->group(function () {
    Route::get('/twitterLogin', 'twitterLogin')->name('twitter.login');
    Route::get('/twitterRedirect', 'twitterRedirect')->name('twitter.redirect');
});
